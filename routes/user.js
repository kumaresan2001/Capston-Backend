...
const {
  passwordResetPage,
} = require("../controllers/auth/password-reset-page");
const { register } = require("../controllers/auth/register");
const {
  profileDetail,
} = require("../controllers/user/order/profileUpdate/profileDetail");
const {
  profilePage,
} = require("../controllers/user/order/profileUpdate/profileUpdate");
