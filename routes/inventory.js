...
const {
  dashboardProducts,
} = require("../controllers/admin/dashboard/dashboardProduct");
const {
  deleteCategory,
} = require("../controllers/admin/category/deleteCategory");
...
const {
  dashboardOverview,
} = require("../controllers/admin/dashboard/dashboardOverview");
